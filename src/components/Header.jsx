          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && isAuthenticated &&(
                <PopupMenuDeskTop user={{ name: user.name, email: user.email,resivado:user.resivado }} logout={logout} handleNavigate={handleNavigate} isAuthenticated={isAuthenticated}/>
              )}
